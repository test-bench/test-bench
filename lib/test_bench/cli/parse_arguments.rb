    ...
    class ParseArguments
      ...
      def option_parser
        @option_parser ||= OptionParser.new do |parser|
          ...
          parser.on('-d', '--tests-directory DIR', %{Directory to scan for test files when none are specified (Default: #{Run::Defaults.tests_directory.inspect})}) do |path|
          ...
          parser.on('-v', '--[no-]verbose', %{Increases output verbosity}) do |verbose|
