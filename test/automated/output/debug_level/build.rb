...
context "Output" do
  context "Debug Level" do
    context "Build" do
      ...
      output = Output::Levels::Debug.build(omit_backtrace_pattern: omit_backtrace_pattern, reverse_backtraces: reverse_backtraces, writer: writer, device: device, styling: styling)
