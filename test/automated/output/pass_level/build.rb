...
context "Output" do
  context "Pass Level" do
    context "Build" do
      ...
      output = Output::Levels::Pass.build(omit_backtrace_pattern: omit_backtrace_pattern, reverse_backtraces: reverse_backtraces, writer: writer, device: device, styling: styling)
