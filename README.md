...
It's not strictly necessary to activate TestBench in order to use it. See the [Use TestBench Without Monkey Patching](http://test-bench.software/user-guide/recipes.html#use-testbench-without-monkey-patching) recipe for specifics.
...
For more information on assertions, including block-form assertions, visit the [documentation page](http://test-bench.software/user-guide/writing-tests.html#assertions).
